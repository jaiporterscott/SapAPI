...
namespace Sap.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        ) : this()
        {
            _host = host;
            _port = port;
            BasePath = $"{_http}{host}{port}{_path}";
        }
        ...
        public Configuration()
        {
            ...
            BasePath = "https://:/sap/opu/odata/sap/API_MAINTNOTIFICATION";
            ...
            {
                {
                    new Dictionary<string, object> {
                        {"url", "https://{host}:{port}/sap/opu/odata/sap/API_MAINTNOTIFICATION"},
                ...
                {
                    new Dictionary<string, object> {
                        {"url", "https://sandbox.api.sap.com/s4hanacloud/sap/opu/odata/sap/API_MAINTNOTIFICATION"},
                        {"description", "No description provided"},
                    }
                }
            };
        ...
        public Configuration(
            ...
            string basePath = "/sap/opu/odata/sap/") : this()
        {
        ...
        {
            string report = "C# SDK (Sap) Debug Report:\n";
