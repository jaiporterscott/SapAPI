...
API's have been generated with OpenAPI Generator 7, then modified to have the required constructors and member variables to correctly create the configurations.
