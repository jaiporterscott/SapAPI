...
{
    /// <summary>
    /// MaintenanceNotificationPartnerCollection
    /// </summary>
    [DataContract(Name = "Collection_of_MaintenanceNotificationPartnerType")]
    public partial class MaintenanceNotificationPartnerCollection : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MaintenanceNotificationPartnerCollection" /> class.
        /// </summary>
        ...
        public MaintenanceNotificationPartnerCollection(string count = default(string), List<MaintenanceNotificationPartnerEntity> results = default(List<MaintenanceNotificationPartnerEntity>))
        {
            this.Count = count;
        ...
        public List<MaintenanceNotificationPartnerEntity> Results { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MaintenanceNotificationPartnerCollection {\n");
