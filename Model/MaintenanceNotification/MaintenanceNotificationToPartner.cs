...
{
    /// <summary>
    /// MaintenanceNotificationToPartner
    /// </summary>
    [DataContract(Name = "cds_api_maintnotification_MaintenanceNotificationType_to_Partner")]
    public partial class MaintenanceNotificationToPartner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MaintenanceNotificationToPartner" /> class.
        /// </summary>
        /// <param name="results">results.</param>
        public MaintenanceNotificationToPartner(List<MaintenanceNotificationPartnerEntity> results = default(List<MaintenanceNotificationPartnerEntity>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MaintenanceNotificationToPartner {\n");
