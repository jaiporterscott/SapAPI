...
{
    /// <summary>
    /// MaintenanceNotificationToItem
    /// </summary>
    [DataContract(Name = "cds_api_maintnotification_MaintenanceNotificationType_to_Item")]
    public partial class MaintenanceNotificationToItem : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MaintenanceNotificationToItem" /> class.
        /// </summary>
        /// <param name="results">results.</param>
        public MaintenanceNotificationToItem(List<MaintenanceNotificationItemEntity> results = default(List<MaintenanceNotificationItemEntity>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MaintenanceNotificationToItem {\n");
