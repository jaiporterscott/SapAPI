...
{
    /// <summary>
    /// MaintNotificationMaintenanceNotificationPartnerTypeUpdate
    /// </summary>
    [DataContract(Name = "cds_api_maintnotification.MaintenanceNotificationPartnerWrapper-update")]
    public partial class MaintNotificationMaintenanceNotificationPartnerTypeUpdate : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MaintNotificationMaintenanceNotificationPartnerTypeUpdate" /> class.
        /// </summary>
        /// <param name="partner">partner.</param>
        public MaintNotificationMaintenanceNotificationPartnerTypeUpdate(string partner = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MaintNotificationMaintenanceNotificationPartnerTypeUpdate {\n");
