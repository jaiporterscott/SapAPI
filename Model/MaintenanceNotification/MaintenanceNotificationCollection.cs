...
{
    /// <summary>
    /// MaintenanceNotificationCollection
    /// </summary>
    [DataContract(Name = "Collection_of_MaintenanceNotificationType")]
    public partial class MaintenanceNotificationCollection : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MaintenanceNotificationCollection" /> class.
        /// </summary>
        ...
        public MaintenanceNotificationCollection(string count = default(string), List<MaintenanceNotificationEntity> results = default(List<MaintenanceNotificationEntity>))
        {
            this.Count = count;
        ...
        public List<MaintenanceNotificationEntity> Results { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MaintenanceNotificationCollection {\n");
