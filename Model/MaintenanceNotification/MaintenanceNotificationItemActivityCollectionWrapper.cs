...
namespace Sap.Model.MaintenanceNotification
{
    ...
    public partial class MaintenanceNotificationItemActivityCollectionWrapper : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MaintenanceNotificationItemActivityCollectionWrapper" /> class.
        /// </summary>
        /// <param name="d">d.</param>
        public MaintenanceNotificationItemActivityCollectionWrapper(MaintenanceNotificationPartnerCollection d = default(MaintenanceNotificationPartnerCollection))
        {
            this.D = d;
        }
        ...
        public MaintenanceNotificationPartnerCollection D { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MaintenanceNotificationItemActivityCollectionWrapper {\n");
