...
{
    /// <summary>
    /// MaintenanceNotificationItemActivityCollection
    /// </summary>
    [DataContract(Name = "Collection_of_MaintNotificationItemActivityType")]
    public partial class MaintenanceNotificationItemActivityCollection : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MaintenanceNotificationItemActivityCollection" /> class.
        /// </summary>
        ...
        public MaintenanceNotificationItemActivityCollection(string count = default(string), List<MaintenanceNotificationItemActivityEntity> results = default(List<MaintenanceNotificationItemActivityEntity>))
        {
            this.Count = count;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MaintenanceNotificationItemActivityCollection {\n");
