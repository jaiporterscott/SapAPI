...
{
    /// <summary>
    /// MaintenanceOrderOperationCollection
    /// </summary>
    [DataContract(Name = "Collection_of_MaintenanceOrderOperationResponse")]
    public partial class MaintenanceOrderOperationCollection : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MaintenanceOrderOperationCollection" /> class.
        /// </summary>
        ...
        public MaintenanceOrderOperationCollection(string count = default(string), List<MaintenanceOrderOperationEntity> results = default(List<MaintenanceOrderOperationEntity>))
        {
            this.Count = count;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MaintenanceOrderOperationCollection {\n");
