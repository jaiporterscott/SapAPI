...
{
    /// <summary>
    /// MaintenanceOrderOperationPRTCollection
    /// </summary>
    [DataContract(Name = "Collection_of_MaintOrderOpProdnRsceTool_Type")]
    public partial class MaintenanceOrderOperationPRTCollection : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MaintenanceOrderOperationPRTCollection" /> class.
        /// </summary>
        ...
        public MaintenanceOrderOperationPRTCollection(string count = default(string), List<MaintenanceOrderOperationPRTEntity> results = default(List<MaintenanceOrderOperationPRTEntity>))
        {
            this.Count = count;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MaintenanceOrderOperationPRTCollection {\n");
