...
{
    /// <summary>
    /// MaintenanceOrderOperationComponentCollection
    /// </summary>
    [DataContract(Name = "Collection_of_MaintOrderOpComponent_Type")]
    public partial class MaintenanceOrderOperationComponentCollection : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MaintenanceOrderOperationComponentCollection" /> class.
        /// </summary>
        ...
        public MaintenanceOrderOperationComponentCollection(string count = default(string), List<MaintenanceOrderOperationComponentEntity> results = default(List<MaintenanceOrderOperationComponentEntity>))
        {
            this.Count = count;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MaintenanceOrderOperationComponentCollection {\n");
