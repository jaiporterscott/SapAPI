...
{
    /// <summary>
    /// MaintenanceOrderPartnerCollection
    /// </summary>
    [DataContract(Name = "Collection_of_MaintenanceOrderPartner_Type")]
    public partial class MaintenanceOrderPartnerCollection : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MaintenanceOrderPartnerCollection" /> class.
        /// </summary>
        ...
        public MaintenanceOrderPartnerCollection(string count = default(string), List<MaintenanceOrderPartnerEntity> results = default(List<MaintenanceOrderPartnerEntity>))
        {
            this.Count = count;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MaintenanceOrderPartnerCollection {\n");
