...
{
    /// <summary>
    /// DummyFunctionImportResultCreate
    /// </summary>
    [DataContract(Name = "cds_api_maintenanceorder_2.DummyFunctionImportResponse-create")]
    public partial class DummyFunctionImportResultCreate : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DummyFunctionImportResultCreate" /> class.
        /// </summary>
        /// <param name="isInvalid">isInvalid.</param>
        public DummyFunctionImportResultCreate(bool? isInvalid = default(bool?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DummyFunctionImportResultCreate {\n");
