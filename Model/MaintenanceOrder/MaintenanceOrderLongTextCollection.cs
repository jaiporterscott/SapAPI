...
{
    /// <summary>
    /// MaintenanceOrderLongTextCollection
    /// </summary>
    [DataContract(Name = "Collection_of_MaintenanceOrderLongText_Type")]
    public partial class MaintenanceOrderLongTextCollection : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MaintenanceOrderLongTextCollection" /> class.
        /// </summary>
        ...
        public MaintenanceOrderLongTextCollection(string count = default(string), List<MaintenanceOrderLongTextEntity> results = default(List<MaintenanceOrderLongTextEntity>))
        {
            this.Count = count;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MaintenanceOrderLongTextCollection {\n");
