...
{
    /// <summary>
    /// MaintenanceOrderOperationComponentLongTextCollection
    /// </summary>
    [DataContract(Name = "Collection_of_MaintOrderOpCompLongText_Type")]
    public partial class MaintenanceOrderOperationComponentLongTextCollection : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MaintenanceOrderOperationComponentLongTextCollection" /> class.
        /// </summary>
        ...
        public MaintenanceOrderOperationComponentLongTextCollection(string count = default(string), List<MaintenanceOrderOperationComponentLongTextEntity> results = default(List<MaintenanceOrderOperationComponentLongTextEntity>))
        {
            this.Count = count;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MaintenanceOrderOperationComponentLongTextCollection {\n");
