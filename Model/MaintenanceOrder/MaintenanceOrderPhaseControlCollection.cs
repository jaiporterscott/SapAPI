...
{
    /// <summary>
    /// MaintenanceOrderPhaseControlCollection
    /// </summary>
    [DataContract(Name = "Collection_of_MaintnanceOrderPhaseControl_Type")]
    public partial class MaintenanceOrderPhaseControlCollection : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MaintenanceOrderPhaseControlCollection" /> class.
        /// </summary>
        ...
        public MaintenanceOrderPhaseControlCollection(string count = default(string), List<MaintenanceOrderPhaseControlEntity> results = default(List<MaintenanceOrderPhaseControlEntity>))
        {
            this.Count = count;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MaintenanceOrderPhaseControlCollection {\n");
