...
{
    /// <summary>
    /// MaintenanceOrderSettlementRuleCollection
    /// </summary>
    [DataContract(Name = "Collection_of_MaintOrderSettlmtDistrRule_Type")]
    public partial class MaintenanceOrderSettlementRuleCollection : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MaintenanceOrderSettlementRuleCollection" /> class.
        /// </summary>
        ...
        public MaintenanceOrderSettlementRuleCollection(string count = default(string), List<MaintenanceOrderSettlementRuleEntity> results = default(List<MaintenanceOrderSettlementRuleEntity>))
        {
            this.Count = count;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MaintenanceOrderSettlementRuleCollection {\n");
