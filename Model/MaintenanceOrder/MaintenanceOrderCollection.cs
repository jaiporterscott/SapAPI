...
namespace Sap.Model.MaintenanceOrder
{
    ...
    /// </summary>
    [DataContract(Name = "Collection_of_MaintenanceOrderResponse")]
    public partial class MaintenanceOrderCollection : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MaintenanceOrderCollection" /> class.
        /// </summary>
        ...
        public MaintenanceOrderCollection(string count = default(string), List<MaintenanceOrderEntity> results = default(List<MaintenanceOrderEntity>))
        {
            this.Count = count;
        ...
        public List<MaintenanceOrderEntity> Results { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MaintenanceOrderCollection {\n");
