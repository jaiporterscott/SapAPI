...
{
    /// <summary>
    /// MaintenanceOrderOperationPhaseControlCollection
    /// </summary>
    [DataContract(Name = "Collection_of_MaintOrderOpPhaseControl_Type")]
    public partial class MaintenanceOrderOperationPhaseControlCollection : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MaintenanceOrderOperationPhaseControlCollection" /> class.
        /// </summary>
        ...
        public MaintenanceOrderOperationPhaseControlCollection(string count = default(string), List<MaintenanceOrderOperationPhaseControlEntity> results = default(List<MaintenanceOrderOperationPhaseControlEntity>))
        {
            this.Count = count;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MaintenanceOrderOperationPhaseControlCollection {\n");
