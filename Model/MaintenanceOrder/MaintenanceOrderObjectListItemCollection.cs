...
{
    /// <summary>
    /// MaintenanceOrderObjectListItemCollection
    /// </summary>
    [DataContract(Name = "Collection_of_MaintenanceOrderObjectListItemResponse")]
    public partial class MaintenanceOrderObjectListItemCollection : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MaintenanceOrderObjectListItemCollection" /> class.
        /// </summary>
        ...
        public MaintenanceOrderObjectListItemCollection(string count = default(string), List<MaintenanceOrderObjectListItemEntity> results = default(List<MaintenanceOrderObjectListItemEntity>))
        {
            this.Count = count;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MaintenanceOrderObjectListItemCollection {\n");
